...
//$sql3 = "select idGameRecords, PlayerA , PlayerB , PlayerAPreRating, PlayerBPreRating, Result, PlayerANewRating, PlayerBNewRating, Counted, GameWeight, HandiValue from GameRecords";
