...
$myquery = @mysql_query("select idGameRecords, PlayerA , PlayerB , PlayerAPreRating, PlayerBPreRating, Result, PlayerANewRating, PlayerBNewRating, Counted from GameRecords")
or die("SQL 失败!");
...
echo "<table border=\"1\">";
echo "<tr> <td>GameID</td> <td>选手A </td> <td>选手B </td> <td>A旧等级分</td> <td>B旧等级分</td><td>结果 </td><td>A新等级分</td><td>B新等级分</td><td>已计算 </td> <td> 选取区 </td></tr>";
